module github.com/sunshine69/webnote-go
...
require (
	...
	github.com/sunshine69/golang-tools/utils v0.0.0-20250810123406-eca07f40041b
...
require (
	...
	github.com/ollama/ollama v0.11.7 // indirect
